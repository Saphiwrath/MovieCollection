    ...
    Scaffold (
        ...
        Column (
            ...
            OutlinedTextField(
                value = "",
                onValueChange = {},
                label = { Text(stringResource(R.string.movie_actors_label)) },
                modifier = Modifier.fillMaxWidth()
            )
            OutlinedTextField(
                value = "",
                onValueChange = {},
                label = { Text(stringResource(R.string.movie_genre_label)) },
                modifier = Modifier.fillMaxWidth()
            )
            OutlinedTextField(
                value = "",
                onValueChange = {},
                label = { Text(stringResource(R.string.movie_format_label)) },
                modifier = Modifier.fillMaxWidth()
            )
        }
    }
